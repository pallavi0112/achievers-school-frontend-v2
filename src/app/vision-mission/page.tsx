...
const breadcrumbs: Breadcrumb[] = [
    { label: "Home", url: "/" },
    { label: "About Us", url: "/vision-mission" },
        ...
        <>
            ...
            <section className="max-sm:px-[10px] sm:px-[30px] lg:px-[50px] xl:px-[100px] md:py-[50px] py-[24px] bg-[#F6F6FF]">
                ...
                <ContentCard
                    ...
                    description={
                        <>
                            <p className="mb-4 text-[16px] md:text-[18px] text-[#000] text-justify"><strong>“Education is not the filling of a pail, but the lighting of a fire.” — William Butler Yeats</strong></p>
                            <p className="mb-4 text-[16px] md:text-[18px] text-[#000] text-justify">Our mission is to create a dynamic and inclusive learning environment that ignites curiosity, fosters creativity, and nurtures character. We aim to make quality education accessible and to provide holistic development through personalized mentorship, immersive experiences, and cutting-edge technology. As pioneers of AI-integrated classrooms and ranked No. 1 CBSE school in the region, we are committed to equipping students with the tools to navigate a complex world. We aspire to inspire a generation of ethical leaders, critical thinkers, and compassionate individuals who will contribute positively to the world around them. At Achievers International School, we believe that when our students succeed, society prospers.</p>
                        </>
                    }
                />
            </section>
