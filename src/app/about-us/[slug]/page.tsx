...
const Page = () => {
    ...
    return   pathname ? routes[pathname] || <h1 className="text-center mt-10 text-red-500 text-2xl">Page Not Found</h1> : <h1 className="text-center mt-10 text-red-500 text-2xl">Page Not Found</h1>;
};
